    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                ...
                <form action="{{ route('payment.update', ['payments' => $payments]) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
                        ...
                        <select name="enrollment_id" id="" class="form-control">
                            ...
                            @foreach ($enrollments as $enroll)
                                <option value="{{ $enroll->id }}" @if ($enroll->id == $payments->enrollment_id) selected @endif>
                                    {{ $enroll->id }}</option>
                            @endforeach
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" name="paid_date" value="{{ $payments->paid_date }}"
